      ...
      [   :ul
        [   :li
            [   :div
                [ :div "resheph" ]
                [   :div
                    " res: " [ :span { :style "color: #20FF20; font-weight: bold;" } 0 ]
                    " inf: " [ :span { :style "color: #FF2020; font-weight: bold;" } 2 ] ] ] ]
        [   :li
            [   :div
                [ :div "ogdoad" ]
                [   :div
                    " res: " [ :span { :style "color: #20FF20; font-weight: bold;" } 1 ]
                    " inf: " [ :span { :style "color: #FF2020; font-weight: bold;" } 0 ] ] ] ] ] )))
